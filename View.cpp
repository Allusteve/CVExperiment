...
View::View(QWidget *parent) :
    ...
    currPhoto(&photo1)
{
    QFile qss(":/res/resource/qss/stylesheet.qss");
    ...
    FERNMenu=new QMenu(tr("FERN特征提取与匹配"),this);
    OpMenu->addMenu(FERNMenu);
    ...
    FERNWith2NN = new QAction(tr("进行野点剔除"),this);
    FERNWithout2NN = new QAction(tr("不进行野点剔除"),this);
    FERNMenu->addAction(FERNWith2NN);
    FERNMenu->addAction(FERNWithout2NN);
    ...
    StitchWithFERN = new QAction(tr("FERN"),this);
    StitchMenu->addAction(StitchWithFERN);
    ...
    connect(FERNWith2NN,SIGNAL(triggered(bool)),this,SLOT(startFERNWith2NN()));
    connect(FERNWithout2NN,SIGNAL(triggered(bool)),this,SLOT(startFERNWithout2NN()));
    ...
    connect(StitchWithFERN,SIGNAL(triggered(bool)),this,SLOT(startStitchWithFERN()));
    //进行传递
...
void View::startFERNWith2NN()
{
    ...
    emit startMatch(file1.toStdString(),file2.toStdString(),4,true);
}

void View::startFERNWithout2NN()
{
    if(file1.isNull() || file2.isNull())
    {
        QMessageBox::critical(this,"发生了错误","请确保两张输入图片");
    ...
    emit startMatch(file1.toStdString(),file2.toStdString(),4,false);
}
...
void View::startStitchWithFERN()
{
    ...
    emit startStitch(file1.toStdString(),file2.toStdString(),4);
}
